...
namespace ER_Diagram_Modeler.Views.Canvas.LabelItem
{
	...
	/// Adorner decorator
	/// </summary>
	public class LabelItemDecorator: Control
	{
		...
		public static readonly DependencyProperty ShowDecoratorProperty =
			DependencyProperty.Register("ShowDecorator", typeof(bool), typeof(LabelItemDecorator),
			new FrameworkPropertyMetadata(false, ShowDecoratorProperty_Changed));

		public LabelItemDecorator()
		{
		...
		private void ShowAdorner()
		{
			if(this._adorner == null)
			{
				...
				_adorner = new ResizeLabelAdorner(designerItem);
		...
		{
			LabelItemDecorator decorator = (LabelItemDecorator)d;
